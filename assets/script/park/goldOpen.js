cc.Class({
    ...
    getMes: function() {
        ...
        ajax(
            urlPrefix + 'lottery/lottery1005.do',
            'periods='+periods,
            function(res) {
                ...
                if (data.state) {
                    ...
                    cc.find('kj/result1img',_this.node).getComponent('cc.Sprite').spriteFrame=imgs.getSpriteFrame(data.data.id_name1);
                    cc.find('kj/resultnum',_this.node).getComponent('cc.Label').string='开奖号码：'+data.data.result+'号、'+data.data.result1+'号';
